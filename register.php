...
<div class="registration">
    ...
    margin-top: 40px;">Регистрация</h2>
        ...
        <form id="form1"method="POST" action=<?=$url?> onsubmit="return validate();">
                    ...
                    while ($recent->have_posts()): $recent->the_post();
                        ...
                        <div class="option">
                            <input
                                    ...
                                    value=<?php the_title(); ?>
                            />
                            <label for=<?= "category".$i++?>><?php the_title(); ?></label>
                        </div>
                    <?php
                    endwhile;
                    ?>
                    ...
                    while ($recent->have_posts()): $recent->the_post();
                        ...
                        <div class="option">
                            <input
                                    ...
                                    value=<?php the_title(); ?>
                            />
                            <label for=<?= "ticket".$i++?>><?php the_title(); ?></label>
                        </div>
            ...
            <div class="checkbox">
                ...
                <label for="agreement">Я согласен на <a href=<?=$redux_demo['linkFor']?>>обработку персональных данных</a>*</label>
